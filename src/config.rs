...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("维议通.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.176.156"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37236;
pub const RELAY_PORT: i32 = 37237;
pub const WS_RENDEZVOUS_PORT: i32 =37238;
pub const WS_RELAY_PORT: i32 = 37239;
