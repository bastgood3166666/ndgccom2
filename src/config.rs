...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.43.137"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 38836;
pub const RELAY_PORT: i32 = 38837;
pub const WS_RENDEZVOUS_PORT: i32 =38838;
pub const WS_RELAY_PORT: i32 = 38839;
