...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("舟议宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.147"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 31556;
pub const RELAY_PORT: i32 = 31557;
pub const WS_RENDEZVOUS_PORT: i32 =31558;
pub const WS_RELAY_PORT: i32 = 31559;
