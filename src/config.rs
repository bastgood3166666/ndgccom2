...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.48"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37836;
pub const RELAY_PORT: i32 = 37837;
pub const WS_RENDEZVOUS_PORT: i32 =37838;
pub const WS_RELAY_PORT: i32 = 37839;
