...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.66.110"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 31456;
pub const RELAY_PORT: i32 = 31457;
pub const WS_RENDEZVOUS_PORT: i32 =31458;
pub const WS_RELAY_PORT: i32 = 31459;
