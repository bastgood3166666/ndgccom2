...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.78"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 30356;
pub const RELAY_PORT: i32 = 30357;
pub const WS_RENDEZVOUS_PORT: i32 =30358;
pub const WS_RELAY_PORT: i32 = 30359;
