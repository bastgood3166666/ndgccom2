...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.85.9"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 38236;
pub const RELAY_PORT: i32 = 38237;
pub const WS_RENDEZVOUS_PORT: i32 =38238;
pub const WS_RELAY_PORT: i32 = 38239;
