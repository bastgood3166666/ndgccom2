...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.11.59"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 33936;
pub const RELAY_PORT: i32 = 33937;
pub const WS_RENDEZVOUS_PORT: i32 =33938;
pub const WS_RELAY_PORT: i32 = 33939;
