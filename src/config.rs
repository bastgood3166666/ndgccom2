...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("新议通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.66.58"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 31756;
pub const RELAY_PORT: i32 = 31757;
pub const WS_RENDEZVOUS_PORT: i32 =31758;
pub const WS_RELAY_PORT: i32 = 31759;
