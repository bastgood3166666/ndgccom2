...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("稳议宝.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.245"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37936;
pub const RELAY_PORT: i32 = 37937;
pub const WS_RENDEZVOUS_PORT: i32 =37938;
pub const WS_RELAY_PORT: i32 = 37939;
