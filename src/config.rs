...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.60.86"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 34936;
pub const RELAY_PORT: i32 = 34937;
pub const WS_RENDEZVOUS_PORT: i32 =34938;
pub const WS_RELAY_PORT: i32 = 34939;
