...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.84.167"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 38636;
pub const RELAY_PORT: i32 = 38637;
pub const WS_RENDEZVOUS_PORT: i32 =38638;
pub const WS_RELAY_PORT: i32 = 38639;
