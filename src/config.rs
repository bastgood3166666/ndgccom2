...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.85.65"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 39136;
pub const RELAY_PORT: i32 = 39137;
pub const WS_RENDEZVOUS_PORT: i32 =39138;
pub const WS_RELAY_PORT: i32 = 39139;
