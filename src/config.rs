...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("平议通.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.43.143"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 38936;
pub const RELAY_PORT: i32 = 38937;
pub const WS_RENDEZVOUS_PORT: i32 =38938;
pub const WS_RELAY_PORT: i32 = 38939;
