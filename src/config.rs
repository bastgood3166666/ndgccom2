...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.11.60"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37136;
pub const RELAY_PORT: i32 = 37137;
pub const WS_RENDEZVOUS_PORT: i32 =37138;
pub const WS_RELAY_PORT: i32 = 37139;
