...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.182"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 39436;
pub const RELAY_PORT: i32 = 39437;
pub const WS_RENDEZVOUS_PORT: i32 =39438;
pub const WS_RELAY_PORT: i32 = 39439;
