...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.42.234"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37636;
pub const RELAY_PORT: i32 = 37637;
pub const WS_RENDEZVOUS_PORT: i32 =37638;
pub const WS_RELAY_PORT: i32 = 37639;
